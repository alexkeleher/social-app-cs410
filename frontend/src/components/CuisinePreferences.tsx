...
// Store image URLs
const images = {
    italian: 'https://www.pvristorante.com/wp-content/uploads/2019/09/blog-1.jpg',
    chinese: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7w188O_VO1oNC3eKmmcppxEphlC0OpASCog&s',
    mexican: 'https://elpueblomex.com/wp-content/uploads/2023/09/fresh-mexican-food-1080x628.jpg',
    japanese:
    ...
    vietnamese: 'https://vietnamtravel.com/images/2020/10/Intro-Vietnam-cuisine1.jpg',
    mediterranean:
    ...
    american: 'https://www.hotelmogel.com/wp-content/uploads/2015/11/iStock_000024270558_Small.jpg',
    spanish: 'https://tekce.net/files/upload/images/spanish-best-cousines-1.jpg',
    middleEastern: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQs6jem_KVJ273knzUt641zrCzXqA4kEAu7EQ&s',
    caribbean: 'https://mccormick.widen.net/content/3s0v7v8372/original/caribbean_2000x1125.jpg',
    african: 'https://www.greenway.co.za/wp-content/uploads/2020/09/sa-foods.jpg',
    latinAmerican:
    ...
    european: 'https://fooddrinklife.com/wp-content/uploads/2024/05/european-food.jpg',
};
        ...
        const fetchPreferences = async () => {
            ...
            try {
                ...
                const savedPreferences = cuisineOptions.reduce(
                    (acc, cuisine) => {
                        acc[cuisine.name] = response.data.cuisinePreferences.includes(cuisine.name)
                            ? PreferenceState.YES
                            : PreferenceState.OFF;
                        return acc;
                    },
    ...
    return (
        <div className="cuisine-preferences-container">
            <div className="cuisine-grid">
                {cuisineOptions.map((cuisine) => (
                    <div key={cuisine.name}>
                        ...
                        >
                            <img src={cuisine.img} alt={cuisine.name} className="cuisine-img" />
                            <p>{cuisine.name}</p>
                        </div>
                    </div>
                ))}
            ...
            <div className="save-preferences">
                <button onClick={handleSavePreferences} disabled={isSaving} className="save-button">
